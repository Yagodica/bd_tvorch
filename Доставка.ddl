...
CREATE TABLE dish (
    ...
    dish_description     VARCHAR2(255) NOT NULL,
...
ALTER TABLE dish_cart ADD CONSTRAINT relation_30_pk PRIMARY KEY ( cart_cart_id,
                                                                  dish_dish_id );
...
ALTER TABLE dish_cart
    ADD CONSTRAINT relation_30_cart_fk
        FOREIGN KEY ( cart_cart_id )
            REFERENCES cart ( cart_id )
                ON DELETE CASCADE;

ALTER TABLE dish_cart
    ADD CONSTRAINT relation_30_dish_fk
